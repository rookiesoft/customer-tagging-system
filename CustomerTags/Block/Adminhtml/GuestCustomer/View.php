...
use AttractSoft\SendEmail\Helper\Data;
...
class View extends Template
{
    ...
    public function getTags()
    {
        $guestCustomerCollection  = $this->guestCustomerCollectionFactory->create()
                    ...
                    ->load();
                    $tagCode = [];
                foreach($guestCustomerCollection as $entityId) {
                    $entityTag = $this->entityTagCollectionFactory->create()->addFieldToFilter('entity_id', $entityId->getId())
                        ->load();

                    foreach($entityTag as $tag) {
                        ...
                        foreach($tagCollection as $tag) {
                            ...
                            //error_log(print_r($tagCode, true));
                            // if($tagCode == null){
                            //     return null;
                            // }
                        }
